The NastrafarmSIGE API is a project that provides programmatic access to manage pig farm data based on the Integral System for Livestock Farm Management (SIGE) by Generalitat de Catalunya.  
